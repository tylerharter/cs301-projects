...
This function should take in a list of dictionaries, **sort based on the username in ascending order** and then write to the file. We've provided the same sort_list_of_dicts() function from P7 to help you do this. 
