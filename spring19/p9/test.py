...
expected_json = {
    ...
    "33": ['play/rb/rb9/89.csv', 'play/rb/rb9/12.xls'],
    "34": ['play/ls/qwe/usun.pdf',
    ...
    "36": ['play/rb/rb9/89.csv',
            ...
            'play/ls/mf.py',
            'play/ls/lu.txt'],
    "37": ['recursive/others/USERID_9.json',
    ...
    "38": ['recursive/others/USERID_9.json',
            'recursive/others/USERID_8.json',
            'recursive/others/USERID_7.json',
            'recursive/others/USERID_6.json',
            'recursive/others/USERID_5.json',
