...
expected_json = {
    ...
    "6": [['10101',
            ...
            'Best kindle charger ever. Took 30 minutes to being my kindle back to life.',
            '5',
            'True',
            '0',
            '2016-11-21'],
            ...
            '0',
            '2016-09-30']],
    "7": 'It does what it is suppose to. No problems with it...',
    "8": 'Perfection',
    "9": 'review3.csv',
    ...
    "32": ['for', 'and', 'the', 'it', 'to', 'i', 'my', 'a', 'this', 'is'],
    "33": ['great',
            'tablet',
            'for',
            'the',
